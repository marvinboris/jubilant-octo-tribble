...
class TeamMemberController extends Controller
{
    ...
    public function show($type, $id)
    {
        ...
        if (!$team_member) return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['team_members']['not_found'], 'danger'),
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['team_members']['created'], 'success'),
        ]);
    }
    ...
    public function update(Request $request, $type, $id)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['team_members']['updated'], 'success'),
            'team_member' => $team_member,
        ]);
    }
    ...
    public function destroy($type, $id)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['team_members']['deleted'], 'success'),
            'team_members' => $team_members,
            'total' => $total,
        ]);
    }
