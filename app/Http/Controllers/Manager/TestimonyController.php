...
class TestimonyController extends Controller
{
    ...
    public function show($type, $id)
    {
        ...
        if (!$testimony) return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['testimonies']['not_found'], 'danger'),
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['testimonies']['created'], 'success'),
        ]);
    }
    ...
    public function update(Request $request, $type, $id)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['testimonies']['updated'], 'success'),
            'testimony' => $testimony,
        ]);
    }
    ...
    public function destroy($type, $id)
    {
        ...
        return response()->json([
            'message' => UtilController::message($cms['pages'][$user->language->abbr]['backend']['messages']['testimonies']['deleted'], 'success'),
            'testimonies' => $testimonies,
            'total' => $total,
        ]);
    }
