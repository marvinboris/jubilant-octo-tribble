...
/* harmony import */ var _store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../store/actions/backend/admins */ "./resources/js/src/store/actions/backend/admins.js");
  ...
  _createClass(Add, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$backend$a2 = _this$props$backend$a.admin,
          admin = _this$props$backend$a2 === void 0 ? {} : _this$props$backend$a2;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_10__.getAdmin)(id));
    },
    post: function post(data) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_10__.postAdmins)(data));
    },
    patch: function patch(id, data) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_10__.patchAdmins)(id, data));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_10__.resetAdmins)());
    }
  };
};
