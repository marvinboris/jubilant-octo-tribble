...
/* harmony import */ var _store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../store/actions/backend/admins */ "./resources/js/src/store/actions/backend/admins.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.pages.admins,
          ...
          _this$props$backend$a2 = _this$props$backend$a.admins,
          admins = _this$props$backend$a2 === void 0 ? [] : _this$props$backend$a2,
      ...
      var data = admins.map(function (admin) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.updateObject)(admin, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_10__.convertDate)(admin.created_at),
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_5__["default"], {
            photo: admin.photo,
            see: see,
            title: "".concat(form.admin_photo, ": ").concat(admin.name)
          }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_9__.getAdmins)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_9__.deleteAdmins)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_admins__WEBPACK_IMPORTED_MODULE_9__.resetAdmins)());
    }
  };
};
