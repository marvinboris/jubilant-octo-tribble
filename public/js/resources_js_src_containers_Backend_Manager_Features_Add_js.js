...
/* harmony import */ var _store_actions_backend_features__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/features */ "./resources/js/src/store/actions/backend/features.js");
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Add, [{
    ...
    value: function componentDidUpdate(prevProps) {
      _utility__WEBPACK_IMPORTED_MODULE_5__.add.lifecycle.componentDidUpdate('features', 'feature')(prevProps, this.props, this.state, this.setState.bind(this), this.resetState);
    }
  }, {
    ...
    key: "render",
    value: function render() {
      var form = this.props.content.cms.pages.backend.pages.features.form;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions_backend_features__WEBPACK_IMPORTED_MODULE_4__["default"].show(id));
    },
    post: function post(data) {
      return dispatch(_store_actions_backend_features__WEBPACK_IMPORTED_MODULE_4__["default"].post(data));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions_backend_features__WEBPACK_IMPORTED_MODULE_4__["default"].patch(id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_features__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
