"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_Subscribers_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/Subscribers/index.js":
/*!**************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Subscribers/index.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../store/actions/backend/subscribers */ "./resources/js/src/store/actions/backend/subscribers.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.pages.subscribers.form,
          _this$props$backend$s = _this$props.backend.subscribers.subscribers,
          subscribers = _this$props$backend$s === void 0 ? [] : _this$props$backend$s;
      var data = subscribers.map(function (subscriber) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.updateObject)(subscriber, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_4__.convertDate)(subscriber.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_3__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_3__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_subscribers__WEBPACK_IMPORTED_MODULE_3__["default"].reset());
    }
  };
};
