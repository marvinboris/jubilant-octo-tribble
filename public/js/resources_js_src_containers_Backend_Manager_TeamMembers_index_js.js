"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_TeamMembers_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/TeamMembers/index.js":
/*!**************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/TeamMembers/index.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_team_members__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/team-members */ "./resources/js/src/store/actions/backend/team-members.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$backend$t = _this$props.backend.team_members.team_members,
          team_members = _this$props$backend$t === void 0 ? [] : _this$props$backend$t;
      var lang = localStorage.getItem('lang');
      var data = team_members.map(function (team_member) {
        var job = team_member.job[lang];
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(team_member, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.convertDate)(team_member.created_at),
          job: job,
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_2__["default"], {
            ...
            see: see,
            title: "".concat(form.team_member_photo, ": ").concat(team_member.name)
          }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_team_members__WEBPACK_IMPORTED_MODULE_4__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_team_members__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_team_members__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
