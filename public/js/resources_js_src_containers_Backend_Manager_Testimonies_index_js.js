"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_Manager_Testimonies_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/Manager/Testimonies/index.js":
/*!**************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Manager/Testimonies/index.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_testimonies__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../store/actions/backend/testimonies */ "./resources/js/src/store/actions/backend/testimonies.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          form = _this$props$content$c.backend.pages.testimonies.form,
          _this$props$backend$t = _this$props.backend.testimonies.testimonies,
          testimonies = _this$props$backend$t === void 0 ? [] : _this$props$backend$t;
      var lang = localStorage.getItem('lang');
      var data = testimonies.map(function (testimony) {
        var company = testimony.company[lang];
        var title = testimony.title[lang];
        var formattedBody = (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.htmlEntities)(testimony.body[lang]);
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.updateObject)(testimony, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_5__.convertDate)(testimony.created_at),
          company: company,
          title: title,
          ...
          photo: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_Backend_UI_List_Photo__WEBPACK_IMPORTED_MODULE_2__["default"], {
            ...
            see: see,
            title: "".concat(form.testimony_photo, ": ").concat(title)
          }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions_backend_testimonies__WEBPACK_IMPORTED_MODULE_4__["default"].get(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions_backend_testimonies__WEBPACK_IMPORTED_MODULE_4__["default"]["delete"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions_backend_testimonies__WEBPACK_IMPORTED_MODULE_4__["default"].reset());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/testimonies.js":
/*!***************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/testimonies.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_0__.manageResource.apply(void 0, ['testimonies', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TESTIMONIES_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TESTIMONIES_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TESTIMONIES_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  reset: function reset() {
    return {
      type: _actionTypes__WEBPACK_IMPORTED_MODULE_1__.TESTIMONIES_RESET
    };
  },
  get: function get(page, show, search) {
